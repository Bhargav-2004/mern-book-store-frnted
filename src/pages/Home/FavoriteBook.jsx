  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='space-y-6 md:w-1/2'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Explore our vast collection and discover your next great read. From bestsellers to hidden gems, we have something for every book lover</p>
